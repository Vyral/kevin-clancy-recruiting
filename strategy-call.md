...
<form method="post" class="home-value cta-forms" action="/thankyou" id="strategy-call-form">
					<fieldset>
						...
						<button class="g-recaptcha" data-sitekey="6LeZSAoaAAAAAPHSyoiY6C7rlQCnpgHHogqH4hmf" data-callback='onStrategyCallSubmit' data-badge="bottomleft">Submit</button></fieldset>
